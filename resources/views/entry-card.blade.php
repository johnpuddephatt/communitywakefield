<div class="entry-card">
  ...
  <div class="entry-card--date">
    <div class="entry-card--date--day">{{ \Carbon\Carbon::parse($entry->start_date)->format('d')}}</div>
    <div class="entry-card--date--month">{{ \Carbon\Carbon::parse($entry->start_date)->format('M')}}</div>
  </div>
  @endif
