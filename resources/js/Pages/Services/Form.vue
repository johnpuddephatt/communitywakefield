<template>
  <app-layout>
    <template #header>
      ...
      <h2 v-else-if="service" class="text-xl font-semibold leading-tight text-gray-800">
        Clone service
      </h2>
    ...
    <template #actions>
      ...
      <div
        v-else-if="service && service.id && service.status == 'Draft'"
      ...
      <div v-else-if="service && service.id" class="mx-4 text-sm font-semibold">
        Expires on {{ add_days(service.updated_at, 90) }}
      </div>
      <jet-secondary-button
        v-if="isDirty && (!(service && service.id) || service.status == 'Draft')"
      ...
      >
      <jet-secondary-button
        v-else-if="!isDirty && service && service.id && service.status == 'Published'"
        @click.native="saveEntry(false)"
        :class="{ 'opacity-25': form.processing }"
        :disabled="form.processing"
      ...
      <p
        class="mx-4 text-sm font-semibold"
        v-else-if="!isDirty && service && !service.id"
      >
      ...
      <jet-button
        v-if="
          (isDirty && !(service && service.id)) ||
          (service && service.id && service.status == 'Draft')
        "
        class="ml-2"
        ...
        <form @submit.prevent="form.post('/login')">
          <jet-fieldset>
            ...
            <template #description>
              Provide the name of your service, choose a category and provide a
              description.
            </template>
            ...
            <template #form>
              ...
              <div class="col-span-6 sm:col-span-6">
                <jet-label
                  for="suitabilities"
                  value="Who is your service suitable for?"
                />
                <jet-multiselect
                  :multiple="true"
                  :expand="true"
          ...
          <jet-fieldset>
            ...
            <template #description>
              Provide contact details for your service. These are optional but will be
          ...
          <jet-fieldset>
            ...
            <template #description>
              Let people know when your service takes place, as well as the cost if
              applicable.
            </template>
          ...
          <jet-fieldset>
            ...
            <template #description>
              Provide the location of your service. Letting people know how to get there
              can be helpful.
            </template>
          ...
          <jet-fieldset>
            ...
            <template #form>
              <div class="col-span-6 sm:col-span-6">
                <jet-label
                  for="accessibility"
                  value="Who is your service accessible to?"
                />
                <jet-multiselect
                  :multiple="true"
                  :expand="true"
