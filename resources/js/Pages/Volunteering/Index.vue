...
<app-layout>
    ...
    <div class="flex flex-col">
        <div v-if="volunteerings.length" class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            ...
                            <tr v-for="volunteering in volunteerings">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <template v-if="volunteering.status == 'Published'">
                                        <span v-if="past_expiry(volunteering.updated_at)" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">
                                            Expired
                                        </span>
                                        <span v-else-if="near_expiry(volunteering.updated_at)" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                            Review now
                                        </span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a :href="route('volunteering.edit', volunteering.id)" class="text-indigo-600 hover:text-indigo-900 pr-6">Edit</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div v-if="!volunteerings.length" class="my-24 flex-1 flex flex-col justify-center items-center">
                ...
                <p class="relative text-gray-400 mt-24">No volunteering opportunities have been added to this team yet. <a class="text-navy" :href="route('volunteering.create')">Create a volunteering opportunity</a></p>
            </div>
        </div>
</app-layout>
</template>
